...
- Exploited vulnerability reachable in the environment and targeting our sector: CVE-2099-00001-SYNTH (last active score 100.0, closed 2026-09-04).
...
3 unchanged, low/medium-severity finding(s) suppressed this cycle.
...
- New vs. recurring (per day): [('2026-09-01', 3, 0), ('2026-09-02', 3, 1), ('2026-09-03', 0, 1), ('2026-09-04', 0, 1)]
- Mean time to triage: 0.0 day(s)
- Mean time to mitigate: 2.0 day(s)
- Overdue critical findings: 0
- Reopened findings (cumulative): 0
- Suppression rate (latest day): 0.5
- False-positive rate (from analyst feedback): 0.0
- Total exposure trend (sum of reportable scores per day): [169.23, 301.64, 304.67, 230.11]