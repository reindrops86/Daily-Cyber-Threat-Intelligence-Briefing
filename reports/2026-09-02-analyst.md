...
**Severity:** critical | **Score:** 100.0 | **State:** UNCHANGED
...
**Severity:** critical | **Score:** 74.35 | **State:** NEW
...
**Score components:** {'base': 62.0, 'amplifier_factor': 1.0, 'source_confidence': 1.05, 'signal_confidence': 0.86, 'asset_multiplier': 1.328}
...
**Severity:** medium | **Score:** 30.77 | **State:** NEW
**What changed:** First observed.
**Why reported today:** state changed to NEW
**Independent sources:** 2
**Evidence:**
...
**Severity:** low | **Score:** 27.29 | **State:** NEW
**What changed:** First observed.
**Why reported today:** state changed to NEW
...
**Severity:** low | **Score:** 16.5 | **State:** PENDING_VERIFICATION _Score and severity reflect the last active measurement on 2026-09-01, not current risk; state is PENDING_VERIFICATION._
**What changed:** No supporting evidence today (1 day(s) since last observed); not yet treated as reduced risk.
**Why reported today:** state changed to PENDING_VERIFICATION
