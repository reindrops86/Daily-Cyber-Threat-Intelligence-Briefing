...
**Severity:** critical | **Score:** 100.0 | **State:** MITIGATED _Score and severity reflect the last active measurement on 2026-09-03, not current risk; state is MITIGATED._
**What changed:** Remediation reported (patch_deployed); pending independent verification.
**Why reported today:** state changed to MITIGATED
...
**Severity:** critical | **Score:** 77.38 | **State:** ACTIVE
**What changed:** Priority moved from 74.35 to 77.38.
...
- [commercial_feed_synth, reliability B, confidence 0.82, supports] Synthetic feed: campaign infrastructure unchanged (fixture). (first seen 2026-09-03, last seen 2026-09-03; source date 2026-09-03; collected 2026-09-03)
...
**What changed:** No supporting evidence today (2 day(s) since last observed); not yet treated as reduced risk.
...
**Severity:** medium | **Score:** 30.77 | **State:** PENDING_VERIFICATION _Score and severity reflect the last active measurement on 2026-09-02, not current risk; state is PENDING_VERIFICATION._
...
**Severity:** low | **Score:** 27.29 | **State:** PENDING_VERIFICATION _Score and severity reflect the last active measurement on 2026-09-02, not current risk; state is PENDING_VERIFICATION._
**What changed:** No supporting evidence today (1 day(s) since last observed); not yet treated as reduced risk.
**Why reported today:** state changed to PENDING_VERIFICATION
...
**Severity:** low | **Score:** 16.5 | **State:** STALE _Score and severity reflect the last active measurement on 2026-09-01, not current risk; state is STALE._
**What changed:** No supporting evidence for 2 day(s), past the 1-day freshness window for this finding type.
